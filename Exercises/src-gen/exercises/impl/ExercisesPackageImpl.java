 ...
 * @generated
 */
public class ExercisesPackageImpl extends EPackageImpl implements ExercisesPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see exercises.ExercisesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ExercisesPackageImpl() {
		super(eNS_URI, ExercisesFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link ExercisesPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ExercisesPackage init() {
		if (isInited)
			return (ExercisesPackage) EPackage.Registry.INSTANCE.getEPackage(ExercisesPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredExercisesPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ExercisesPackageImpl theExercisesPackage = registeredExercisesPackage instanceof ExercisesPackageImpl
				? (ExercisesPackageImpl) registeredExercisesPackage
				: new ExercisesPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theExercisesPackage.createPackageContents();

		// Initialize created meta-data
		theExercisesPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theExercisesPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ExercisesPackage.eNS_URI, theExercisesPackage);
		return theExercisesPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getDFA_Transition() {
	...
	public void createPackageContents() {
		...
		createEReference(dfaEClass, DFA__TRANSITION);
	...
	public void initializePackageContents() {
		...
		initEReference(getDFA_States(), this.getState(), null, "states", null, 0, -1, exercises.DFA.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDFA_Transition(), this.getTransition(), null, "transition", null, 0, -1, exercises.DFA.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getState_IsEnd(), ecorePackage.getEBoolean(), "isEnd", null, 0, 1, State.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getState_Incoming(), this.getTransition(), null, "incoming", null, 1, -1, State.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getState_Outgoing(), this.getTransition(), null, "outgoing", null, 1, -1, State.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
